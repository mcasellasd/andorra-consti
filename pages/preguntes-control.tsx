...
export default function PreguntesControlPage() {
  ...
  return (
    <>
      <Head>
        <title>Preguntes de Control - Avaluació · dretplaner.ad</title>
        <meta
          name="description"
          content="Sistema d'avaluació i control de qualitat per a les respostes de la IA jurídica."
        />
      </Head>
      <Layout>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
          ...
          <p>
            Aquest sistema permet avaluar si Dret Planer està ben entrenat executant
          ...
          <div style={{ marginTop: '3rem', padding: '1.5rem', backgroundColor: '#e7f3ff', borderRadius: '8px' }}>
            <h2>Informació</h2>
            <p>
              Aquest sistema avalua el rendiment de Dret Planer executant preguntes de control amb
              criteris objectius:
            </p>
            <ul>
              <li>
