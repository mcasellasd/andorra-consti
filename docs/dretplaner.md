...
*La intel·ligència artificial estreta (Narrow AI), utilitzada com a sistema cohesionador de suport lingüístic i interpretatiu, pot contribuir a millorar la comprensió de la producció legislativa i normativa redactada en llenguatge jurídic natural, sense substituir la funció interpretativa pròpia dels operadors jurídics ni vulnerar els principis de legalitat i control humà.*

Aquest article analitza l'eficàcia de la Intel·ligència Artificial estreta com a instrument d’integració i garantia de comprensió del sistema jurídic andorrà. La base de l’article és demostrar la capacitat dels models de llenguatge generatius com una eina vàlida per facilitar la comprensió jurídica als receptors obligats. 

Davant la barrera cognitiva del llenguatge tècnic, s'invoca la doctrina del Dret a Comprendre (Carretero) com a un dret fonamental. Aquesta exigència s'alinea amb l'anàlisi recent de Marta Pujol i Anna Gabernet, les quals destaquen que la comunicació clara a Andorra ha passat de ser un criteri d'estil a un mandat legal vinculant arran de l'aprovació de la **Llei 6/2024 de la llengua pròpia i oficial**. Aquesta norma obliga les institucions públiques, i específicament l'Administració de justícia, a utilitzar un llenguatge "accessible, acurat i comprensible" per garantir la transparència i facilitar les relacions amb la ciutadania

En aquest treball s’ha creat una plataforma d’ajuda a la comprensió de la Constitució com a  text legislatiu superior, contracte fundacional, base del sistema jurídic. Així, acceptant que la Constitució actua com a **Regla de Reconeixement** (JLA Hart) de l'ordenament, cal acceptar la seva importància sociològica com és el coneixement i acceptació interna per part d'una ciutadania demogràficament diversa, de manera que del seu seguiment en depengui la validesa.
...
I. Introducció: El dret a comprendre a l'era de la intel·ligència artificial

En l'arquitectura de qualsevol Estat de dret, la publicitat de les normes és una condició necessària, però no suficient. 

Tal com va postular Lon Fuller (1964), la claredat és un dels requisits essencials de la moralitat interna del Dret: una llei que no s'entén no pot ser obeïda ni, per tant, pot ser considerada plenament vàlida en la seva funció social. 

0.0 Intro  
Aquest projecte està desenvolupat amb l’objectiu d’entendre i aprofundir en les capacitats de la IA en l’àmbit jurídic. La literatura existent, en termes generals, atribueix certes capacitats i alhora mancances als sistemes IA posada a disposició per a la tasca jurídica. En termes generals la IA s’ha demostrat molt eficaç en gestió de processos de gran volums de documentació però perillosa per la seva capacitat inventiva o de biaix. Sembla clar que la IA no pot donar solucions, per ara, als grans problemes de la justícia si bé pot ser eficaç en determinades tasques jurídiques. Una d’elles és assistir als diferents professionals a través del resum i connexió de moltes dades en poc temps. No obstant, no deixa de ser una pràctica sotmesa als riscos de la propietat privada inherent a la lex artis. També existeixen aplicacions orientades a oferir consell o emetre opinió jurídica automatitzada sobre uns fets concrets, les quals tampoc poden substituir al consell professional col·legiat. Ara bé, els models de llenguatge (LLM) han demostrat la capacitat per generar textos, resums i gestionar informació eficientment. Acreditat aquest punt, penso que es pot desenvolupar una IA que es limiti a fer allò que sap fer bé, com ara la interpretació del llenguatge. Quelcom que, als partidaris del Dret a Comprendre ja estan duent a la pràctica. 

Per tant una d’aquestes pràctiques, a priori validades, és la interpretació al llenguatge natural dels preceptes jurídics presents als diferents codis i reglaments. Una eina capaç de refrassejar el literal de la llei a un llenguatge planer, molt més comprensible i intuïtiu. I sobre aquesta base, maximitzant les capacitat que la IA ofereix a través d’exemples aplicats,  capacitats de personalitzar preguntes o altres formes d’estructurar i connectar la informació.
...
* Anàlisi Individual: Cada article pot ser analitzat per separat a través d’una explicació automatitzada en llenguatge planer, complementada amb exemples d’aplicació pràctica del precepte i un comentari doctrinal o jurisprudencial que en destaca la rellevància o la història.  
  * permet que qualsevol ciutadà pugui interpel·lar la Constitució d'Andorra i rebre, sota demanda, una explicació del precepte legal en llenguatge planer.

### **0.2. Objecte de l'estudi**

Aquest article té per objectiu documentar una prova de concepte (PoC) la interpretació del precepte normatiu, mitjançant la generació amb IA de llenguatge planer, pot actuar com un **mecanisme de cohesió jurídica constitucional** en un context jurídic nacional per evitar distorsions interpretatives.

0.3 Disclaimer  
Aquest document no pretén
...
L’article de Burgos Martínez (2025) analitza com l’ordenament espanyol ha fet un pas molt rellevant en la positivització del “dret a comprendre” a través de la noció d’accessibilitat cognitiva, especialment amb la Llei 6/2022 i la Llei 5/2024, però posant de manifest una paradoxa: les mateixes normes que proclamen aquest dret continuen redactades en un llenguatge jurídic clàssic, dens i difícilment comprensible per al públic general. A partir d’un estudi cronològic d’aquest marc normatiu, l’autora mostra com es consolida el reconeixement formal del dret a comprendre alhora que persisteix una bretxa entre proclamació i efectiu accés cognitiu, fins al punt que les disposicions sobre accessibilitat cognitiva acaben vulnerant, en la pràctica, el mateix dret que pretenen garantir, i proposa com a via de superació l’adaptació de les normes a lectura fàcil, que il·lustra amb un exemple concret.​

El desenvolupament doctrinal i institucional del 'dret a comprendre' a Espanya té un punt d'inflexió amb la creació, per Acord del Consell de Ministres de 30 de desembre de 2009, de la Comissió de Modernització del Llenguatge Jurídic (CMLJ), integrada per representants del Ministeri de Justícia, del Consell General del Poder Judicial, de la Fiscalia General de l'Estat i de la Real Academia Española. Aquesta iniciativa multidisciplinària va produir un Informe i unes Recomanacions que configuren el 'dret a comprendre' com el dret de la ciutadania a entendre tant la norma com el discurs jurídic que produeixen els professionals del dret, fonamentat constitucionalment en la dignitat de la persona (art. 10.1 CE), la seguretat jurídica i la interdicció de l'arbitrarietat (art. 9.3 CE), la tutela judicial efectiva (art. 24 CE) i el dret a rebre informació veraç (art. 20 CE).

Pel que fa al context andorrà, Pujol Palau i Gabernet Piqué (2024) destaquen l’evolució de la política lingüística del Principat, especialment arran de l’aprovació de la Llei 6/2024 de la llengua pròpia i oficial, la qual estableix que el llenguatge institucional ha de ser “accessible, acurat i comprensible”. Les autores remarquen que la manca de comprensió de documents oficials pot constituir una vulneració de drets fonamentals, i situen el Manual de llenguatge jurídic (2017) del Consell Superior de la Justícia com una eina clau en aquesta matèria.
...
III.1. El dret a la comprensió en el marc internacional i europeu  
...
Conveni Europeu de Drets Humans (TEDH): El Conveni exigeix explícitament que les persones acusades d'un delicte (article 6.3) o detingudes (article 5.2) siguin informades de les causes de l'acusació formulada "en un idioma comprensible" (Conveni Europeu de Drets Humans, 1950). Unió Europea (UE): La Carta dels Drets Fonamentals de la Unió Europea (article 47\) consagra el dret a la tutela judicial efectiva, la qual cosa implica que la manca de comprensió de les resolucions judicials pot impedir l'exercici adequat de la defensa dels drets i interessos (Carta dels Drets Fonamentals de la Unió Europea, 2000).

2.2.2. El Dret a comprendre a ‘àmbit iberoamericà  
La positivització del dret a comprendre a Espanya, malgrat els avenços normatius recents, presenta una paradoxa estructural que ha estat analitzada per Burgos Martínez (2025): les mateixes normes que regulen l'accessibilitat cognitiva —com ara la Llei 6/2022— continuen redactades en llenguatge jurídic tradicional, sense adaptacions a lectura fàcil ni versions en llenguatge clar, de manera que esdevenen incomprensibles per a la major part de la ciutadania i vulneren, en la pràctica, el mateix dret que pretenen garantir. Mitjançant una anàlisi cronològica de més de vint normes estatals, l'autora constata que, si bé existeix una proliferació normativa que al·ludeix a l'accessibilitat universal i cognitiva, cap d'aquestes normes ha estat redactada seguint pautes de llenguatge clar, i menys de la meitat compten amb adaptacions accessibles (llenguatge de signes, vídeo o lectura fàcil). Aquesta desconexió entre proclamació formal i aplicació efectiva reflecteix el que Carretero i Fuentes (2019) anomenen 'acumulació normativa farragosa', que retroalimenta la falta de claredat i converteix el dret a comprendre en una aspiració difusa sense estatut jurídic propi ni via de reclamació judicial.

Com a resposta pràctica, Burgos Martínez proposa una adaptació validada a lectura fàcil de l'Ordre JUS/912/2022 sobre modernització del llenguatge jurídic, seguint la metodologia de la norma UNE 153101:2018 i validant-la amb un grup de sis persones amb discapacitat cognitiva. Aquesta proposta demostra la viabilitat tècnica de la simplificació normativa, però també posa de manifest les seves limitacions: l'adaptació manual és lenta, costosa i difícilment escalable a tot l'ordenament jurídic. En aquest context, la IA estreta es presenta com a eina complementària indispensable per automatitzar, amb supervisió humana, la generació de versions en llenguatge clar de textos normatius, judicials i administratius, superant així la paradoxa espanyola i fent operatiu, a escala, el dret a una justícia comprensible que proclamen les lleis però que no acaben de materialitzar.

Els treballs de la CMLJ van identificar els obstacles lingüístics que dificulten la comprensió del discurs jurídic espanyol: l'ús d'arcaismes i formulismes, la sintaxi de subordinació concatenada, l'abús de construccions impersonals i passives, i la proliferació de perífrasis nominals que oculten els actors i les accions. A partir d'aquests diagnòstics, es van proposar mesures concretes d'implantació de llenguatge clar en l'àmbit normatiu i judicial, incloent-hi la formació dels professionals del dret, l'estandardització de documents judicials, l'elaboració de materials d'autoajuda legal per a la ciutadania i la incorporació de tecnologies al servei de la claredat. El posterior Llibre d'Estil de la Justícia (2017), fruit de la col·laboració entre el CGPJ i la RAE, concreta aquests criteris i reconeix que la clarificació del llenguatge jurídic no implica renunciar a la precisió tècnica, sinó transformar la forma d'expressió per fer-la accessible sense perdre rigor.

Jurisprudència que reconeix la indefensió: Cort Suprema d'Argentina (CSJN): La Cort ha criticat resolucions de cambra amb una "redacción confusa, complicada e ininteligible en algunos párrafos" que impedia apreciar el raonament i dificultava la correcta defensa dels drets. Un tribunal argentí va sostenir que un litigant no pot ser considerat temerari si, per manca de precisió en el significat de les paraules d'una sentència, la interpreta erròniament (Arballo & Maraschio, 2024).  
Justícia colombiana: La Cort Constitucional (Sentència T-311 de 2024\) va determinar que la manca de claredat en les actuacions administratives pot generar una violació del degut procés, ja que l'ús de llenguatge tècnic sense explicació o fórmules rituals feia incomprensible el missatge per al ciutadà comú (Corte Constitucional de Colombia, Sentencia T-311/24, 2024).  
Incompliment del deure d'informació: En el cas de Colòmbia, la falta de claredat genera indefensió, ja que els missatges de l'Administració no resulten "comprensibles" (Escudero Henao, 2024).  
Notificacions: Les Regles de Brasília (aprovades per la Cimera Judicial Iberoamericana) exigeixen que en les "notificaciones y requerimientos" s'utilitzin termes i estructures gramaticals "simples y comprensibles" per a les persones en condició de vulnerabilitat, garantint que puguin comprendre'n l'abast i el significat (Regles de Brasília, 2008, Regla 59; actualitzades el 2018).  
Com s'ha exposat anteriorment, la Comissió de Modernització del Llenguatge Jurídic a Espanya (2011) va identificar aquestes "patologies lingüístiques i textuals" que dificulten la comprensió: l'abús d'oracions subordinades, l'ús incorrecte de la puntuació, l'ús excessiu de la veu passiva, arcaismes i tecnicismes innecessaris (Comissió de Modernització del Llenguatge Jurídic, 2011).

III.3. El dret a comprendre en català  
...
Tot i que no hi ha jurisprudència directa del Tribunal Constitucional d'Andorra que reiteri aquest punt específicament en relació amb la comprensió lingüística, el Principat va signar la Declaració d'Asunción-Paraguai (2016), la qual afirma que la legitimitat de la judicatura està lligada a la "claredat i qualitat de les resolucions judicials" i que això constitueix un "verdader dret fonamental" (Declaració d'Asunción-Paraguai, 2016). A més, la Llei 6/2024, de la llengua pròpia i oficial d'Andorra, exigeix que el llenguatge de la Justícia sigui "accessible, acurat i comprensible" (Llei 6/2024, 2024).

La llei andorrana que fomenta el llenguatge comprensible i l'accessibilitat en les comunicacions públiques és la Llei 6/2024, del 25 d’abril, de la llengua pròpia i oficial.
...
III.5. Mecanismes institucionals de gestió i implementació  
El marc jurídic andorrà ha establert mecanismes de coordinació i d'acció transversal que legitimen la implementació de la IA com a assistència en la tasca de clarificació:  
• Coordinació transversal: La Llei 6/2024 preveu la creació del Consell Nacional per la Llengua (CNL) i la Junta de Coordinació sobre Llengua i Formació (JCLF) per coordinar la política lingüística, cosa que facilita l'aplicació dels principis de la comunicació clara a totes les administracions.  
• Eines de simplificació: La Secretaria d’Estat d’Afers Socials ha creat la Unitat de Simplificació Administrativa i Gestió Digital, un dels objectius de la qual és fer més clar el llenguatge dels tràmits i adaptar documents a format de lectura fàcil.  
• Integració digital judicial: L'Administració de Justícia andorrana es regeix per la Llei 7/2022, del 31 de març, d’accés electrònic, que promou la digitalització dels processos judicials. Tot i que aquesta llei no recull els principis de comunicació clara de forma explícita, l'obligació de claredat ja recau en els òrgans jurisdiccionals per via de la Declaració d’Asunción-Paraguai subscrita pel Principat el 2016\.

III.6. El català com a eix constitucional i de transparència  
Com ja s'ha exposat a la secció III.4, la Constitució d'Andorra estableix el català com a llengua oficial (art. 5), principi reafirmat i desenvolupat amb la Llei 6/2024. La claredat es considera un criteri fonamental de bon govern i transparència, i l'Administració té la responsabilitat d'emprar un llenguatge accessible, acurat i comprensible, ja que això fa efectiva la transparència de les comunicacions públiques i facilita les relacions dels ciutadans amb l'Administració (Pujol Palau & Gabernet Piqué, 2024).  
III.7. El dret a comprendre en l'Administració de Justícia  
Mandat legal de claredat: La llei exigeix als òrgans rectors de l'Administració de Justícia que promoguin l'ús de la llengua oficial i que utilitzin un llenguatge jurídic i tècnic de qualitat i accessible als usuaris (Llei 6/2024, 2024; Consell Superior de la Justícia del Principat d’Andorra, 2017).  
Indefensió per incomprensió: La manca de comprensió de les resolucions judicials o administratives vulnera un dret fonamental, ja que sense comprensió, el ciutadà no es pot defensar. La claredat i la qualitat de les resolucions judicials es consideren un "verdader dret fonamental" (Carretero González, 2024a; Raonador del Ciutadà, citat a Pujol Palau & Gabernet Piqué, 2024).

III.8. El català clar com a eina d'integració i cohesió social  
...
III.9. El català com a llengua oficial i els reptes sociolingüístics  
El dret andorrà reconeix el català com l'única llengua oficial del Principat. En aquest sentit, la recent Llei 6/2024 de la llengua pròpia i oficial estableix de manera explícita que l'Administració de Justícia i les institucions en general han d'utilitzar un llenguatge "accessible, acurat i comprensible". Aquest mandat es veu reforçat pel fet que la qualitat de l'atenció i la claredat dels documents són indicadors de bon govern (Llei 6/2024, 2024; Pujol Palau & Gabernet Piqué, 2024).  
No obstant això, els estudis sociolingüístics i els informes mostren que l'ús del català enfront del castellà, i en menor mesura el francès, s'enfronta a desafiaments: Prevalença del castellà en l'ús social: El castellà és percebut com el principal competidor del català, i és la llengua predominant en sectors com la restauració, els grans magatzems i el transport públic. A més, el castellà és l'idioma més utilitzat habitualment per comunicar-se per la majoria de la població enquestada (Andorra Recerca i Innovació. Grup de Sociologia, 2022; Torres Pla, 2024).

\- Canvi de llengua i abandonament  
Les dades mostren que els catalanoparlants canvien al castellà en les converses en un 74% de les vegades quan l'interlocutor respon en castellà. Aquesta tendència, juntament amb el fet que molts funcionaris canvien d'idioma davant del ciutadà, malgrat que s'observa que "massa sovint i de manera inconscient es canvia d’idioma abans que l’interlocutor mostri dificultats de comprensió", debilita el valor simbòlic del català (Andorra Recerca i Innovació, 2023; Serra i Massansalvador, 2024).

Llengua d'instrucció diversa  
La funció de la IA és principalment la traducció del llenguatge jurídic tècnic a un llenguatge comú, o la generació de resums en "llenguatge entenedor". Aquesta simplificació es dirigeix a combatre les "patologies lingüístiques i textuals" com frases llargues, arcaismes o sintaxi complexa (Vallès i 

Elizalde, 2007; Montolío Durán & Bayés-Gil, 2024).  
L'existència de diversos sistemes educatius a Andorra (andorrà, espanyol, francès i britànic) fa que l'escolarització es faci en diverses llengües vehiculars (català, castellà i francès), la qual cosa contribueix a la pluralitat lingüística del país (Govern d’Andorra. Departament d’Estadística, 2023).  
L'ús de la IA s'emmarca en la necessitat de simplificar el llenguatge jurídic, no per traduir a altres idiomes d'entrada, sinó per garantir que el català, com a llengua oficial, sigui comprensible i funcional per a tothom (Matamala, 2024; Arnall Duch et al., 2024).

Reforç del català estàndard  
Aplicar l'IA, com es proposa per al Portal Jurídic de Catalunya, per generar resums clars i concisos de normes, assegura que l'Administració utilitzi el català com a eina de comunicació eficaç. Això reforça el català com a instrument accessible, en lloc de com un codi extern (Albanell Sais, 2024; Acord GOV/29/2024, 2024).

Minimització d'al·lucinacions  
La IA narrow (estreta) o específica pot ser entrenada per fer tasques com la simplificació de textos legals, minimitzant el risc d'inexactituds o "al·lucinacions". No obstant això, sempre es requereix supervisió humana (Saggion, 2024; Escudero, 2024).

---

## **1\. EL REPTE DE LA COMPRENSIÓ NORMATIVA A ANDORRA**

### **1.1. Context sociodemogràfic singular**

El Principat d'Andorra presenta una realitat sociodemogràfica diferenciadora en el context europeu. Amb un percentatge de població resident d'origen immigrant que s'apropa al 55%, la xifra més actual rebassa per poc els 89.000 habitants en una fita històrica. L'excepcionalitat andorrana es fa evident en comparar-la globalment (vegeu Taula 1). Andorra se situa, juntament amb Mònaco i els estats del Golf, en l'exclusiu grup de països on la població nacional és minoria. Aquesta estructura demogràfica implica que la majoria dels subjectes obligats per la norma (el 55,4% dels residents i el 100% dels milions de visitants) no han estat socialitzats en el sistema jurídic ni educatiu del país. I amb una economia oberta amb un alt flux de visitants i inversors, el país s'enfronta a un repte jurídic de primer ordre: la cohesió normativa.![][image1]
...
En aquest context, el dret andorrà, històricament basat en el *ius commune* i el costum, pot resultar obscur per a una població acostumada a la codificació. La necessitat de cohesió normativa esdevé, doncs, un repte de primer ordre: cal garantir que una població majoritàriament forana comprengui i accepti les normes d'un sistema en el qual no participa políticament.

**1.1.1 La funció del dret: *ignorantia iuris non excusat***

El Dret té per objectius guiar les conductes de les persones en una societat i proporcionar un marc de previsibilitat que permeti als ciutadans conèixer les conseqüències dels seus actes i planificar les seves vides. I aquí entra, també, les funcions de l’Estat com aquell ens que ha de posar a disposició dels ciutadans les eines i mecanisme per tal de garantir la possibilitat d’assumpció d’aquest objectiu vital. Aquest dret o objectiu individual es configura com un doble mecanisme amb drets i, deures. La part positiva, és a dir, d’igual manera que tenim dret a accedir als mecanisme que ens posa l’Estat també, però, hem de satisfer les obligacions que això comporta. Cada ciutadà ha de col·laborar solidària i justament amb el sustent de l’Estat del Benestar.

Per tant, el dret positiu, les normes imperatives en una societat en un moment determinat representa la manera d’expressar els seus valors en els quals volen conviure i, en el cas andorrà, resultant en una forma d’expressió de sobirania nacional. En aquesta línia, cal admetre que el coneixement del sistema jurídic del territori on s’està físicament seguint el proverbi llatí  *Si fueris Rōmae, Rōmānō vīvitō mōre.* (Si estàs a Roma, fes com els romans). La idea és fàcil, si vas a Andorra fes com fan els andorrans, respecta les seves tradicions i cultura i, més important, adapta-t’hi. 

Conèixer el Dret del lloc on es visita és conèixer la intimitat moral, una nudesa intel·lectual sobre la cultura jurídica del lloc i la priorització dels valors moral crítics. Certament, per un visitant o una persona que passa un dies al país no li hauria de resultar necessari tenir massa coneixement jurídic si bé és innegable que el contacte amb el Dret i els drets subjacents resulten intactes. La permeabilitat del dret, com a eix, guia conductual empapa locals i visitants, sense distinció dels eventuals càstigs penals.

Pel un principi de transparència i claredat la llei fixa el termes del comportament moral crític i positiu,

La interferència amb el dret és quasi inevitable. 

Si bé la legislació andorrana prové, en part, d’una herència romana hi ha molts principis jurídics que es comparteixen amb els visitants.
...
## **2\. LA CONSTITUCIÓ ANDORRANA**

### **2.1. Andorra sota la lupa de Hart: La Constitució com a Regla de Reconeixement "viva"**

Segons la cèlebre teoria de H.L.A. Hart, l'existència d'un sistema jurídic depèn d'una **Regla de Reconeixement**: una norma última que estableix els criteris de validesa de la resta de normes. A Andorra, des de 1993, aquesta regla és la Constitució escrita, que va substituir l'antic sistema basat en els Pariatges i el costum.
...
Segons Vilajosana la RR de Hart és una convenció amb una dimensió constitutiva, contraposat amb el concepte de convicció. Fem les coses perquè pensem que els altres facin el mateix donada la mateixa situació alhora que, aquests tercers, també pensarien que actuar d’aquella manera és el que s’espera d’ells.

En aquest sentit, tornem a la idea de la importància d'identificar el sistema jurídic de la societat de la qual se’n forma part. Certament, la Constitució d’Andorra, salvant les particularitats històriques, respón a un model summament difós arreu, de manera que els grans reptes es presenten en la declinació en altres lleis, reglaments o ordinacions. No obstant, conèixer la Constitució particular d’un país és conèixer la pedra angular en la qual versa tota la resta de l’ordenament jurídic. 
...
Per tant, existeix un gruix de població que, per raons administratives o extemporànies no han format part d’aquest procés i poden no tenir-ne un coneixement tan profund del que seria desitjable des d’un punt de vista de la cohesió interpretativa del dret. El desconeixement del text marc, doncs, no és dona única i necessàriament a nouvinguts, sinó també a residents consolidats al país. De fet, Serra, adverteix del poc o escàs interés que tenen les segones generacions d’andorrans per la cultura o les institucions andorranes.

# IV. Marc teòric-jurídic de la Intel·ligència Artificial i principis rectors

IV.1. Conceptes fonamentals: IA estreta vs. IA generativa  
...
IV.2. IA generativa o models de llenguatge extens (LLM)  
...
Estat de l’art en projectes jurídics IA  
...
V. Proof of Concept: Prudència.ad – IA per al dret clar andorrà  
V.1. Marc jurídic i plantejament conceptual  
V.1.1. Base normativa i principis fundacionals  
El projecte Prudència.ad s'articula sobre una base jurídica sòlida que reflecteix els compromisos andorrans amb l'accessibilitat lingüística i la transparència jurídica. La Constitució del Principat d'Andorra (1993) estableix en l'article 2.1 que el català és la llengua oficial de l'Estat, un principi que no només garanteix l'ús institucional de la llengua sinó que també implica l'obligació de fer accessible el dret a tots els ciutadans, independentment del seu nivell de coneixement jurídic o lingüístic.  
Aquest compromís constitucional es desenvolupa posteriorment en la Llei 6/2024, de llenguatge accessible, que estableix el marc normatiu per garantir que la informació jurídica i administrativa sigui comprensible per a tots els ciutadans. Aquesta llei reconeix explícitament la necessitat de simplificar el llenguatge jurídic sense perdre precisió, un repte que la intel·ligència artificial pot abordar mitjançant tècniques de processament de llenguatge natural (PLN) especialitzades.  
V.1.2. Valor afegit i focus andorrà  
V.1.2.1. Diferenciadors estratègics  
Català clar natiu: A diferència de solucions basades en traducció automàtica (com Google Translate), Prudència.ad genera text simplificat directament en català, sense passar per altres llengües. Això garanteix que les simplificacions respectin les particularitats del català jurídic andorrà i no introdueixin errors de traducció o pèrdues de significat.  
Mosaic normatiu andorrà: El sistema reconeix i integra la complexitat del sistema jurídic andorrà, que combina:  
\- Dret nacional andorrà (lleis, decrets, resolucions)  
\- Dret internacional (TEDH, convenis internacionals)  
\- Dret comparat (Regles de Brasília, principis europeus)  
Aquesta integració permet que les respostes reflecteixin la realitat jurídica andorrana, on múltiples fonts normatives coexisteixen i s'influencien mútuament.  
Especialització en dret andorrà: Mentre que les solucions genèriques d'IA jurídica sovint es basen en corpus de dret espanyol, francès o anglès, Prudència.ad s'especialitza específicament en el dret andorrà, garantint que les respostes siguin precises i rellevants per als ciutadans andorrans.  
V.1.2.2. Abast i integració institucional  
Portal obert (prudencia.ad): El sistema es desplega com a portal públic obert, accessible a tots els ciutadans sense restriccions. Això garanteix que l'accessibilitat jurídica no estigui limitada per barreres econòmiques o tècniques.  
Integració CASS/Justícia: El sistema s'integra amb els sistemes de la Caixa Andorrana de Seguretat Social i del sistema judicial, permetent processar automàticament resolucions i decisions i generar versions simplificades que es distribueixen juntament amb els documents originals.  
API pública: El sistema ofereix una API pública que permet a altres aplicacions i serveis integrar les capacitats de simplificació, ampliant l'abast del projecte més enllà del portal web.  
V.1.2.3. Impacte social i governamental  
Els principals objectiu del projecte inclouen:  
\- Desenvolupament d'un sistema especialitzat en català jurídic andorrà  
\- Implementació d'una arquitectura RAG que garanteix la precisió de les respostes  
\- Integració de múltiples fonts normatives (nacionals, internacionals, comparades)  
Cohesió immigrant: Andorra té una població amb un alt percentatge d'immigrants que poden tenir dificultats per comprendre el dret andorrà en català. Prudència.ad contribueix a la cohesió social facilitant l'accés al dret per a tots els ciutadans, independentment del seu origen o nivell de coneixement jurídic.  
Bon govern: El sistema promou la transparència i l'accessibilitat de la informació pública, principis fonamentals del bon govern. En fer el dret més accessible, el sistema empodera els ciutadans i millora la qualitat democràtica.  
IA pública (no Google Translate): A diferència de dependre de solucions privades externes (com Google Translate), Prudència.ad és una solució d'IA pública desenvolupada específicament per a les necessitats andorranes. Això garanteix:  
\- Sobirania de dades: Les consultes i documents no surten del territori andorrà  
\- Control del desenvolupament: El sistema es pot adaptar i millorar segons les necessitats específiques  
\- Independència tecnològica: Reducció de la dependència de serveis externs privats  
A més, el projecte contribueix a la recerca en:  
\- PLN per a llengües minoritzades: El desenvolupament de solucions d'IA per al català jurídic contribueix a la recerca sobre processament de llenguatge natural per a llengües amb recursos limitats.  
\- IA explicable en dret: La implementació de XAI en el context jurídic proporciona insights valuosos sobre com fer les IA més transparents i auditables.  
\- Simplificació jurídica assistida per IA: El projecte explora noves formes d'aplicar la IA a la simplificació del llenguatge jurídic, mantenent la precisió mentre millora l'accessibilitat.
...
\*\*Embeddings i generació.\*\* Es va passar d'OpenAI a XLM-RoBERTa-base (\*lib/embeddings/xlm-roberta.ts\*, \*docs/XLM-ROBERTA-SETUP.md\*) per costos i privacitat; es documenta la futura migració a \*roberta-base-ca-v2\* (Projecte AINA). La generació es va provar amb Salamandra-7b-instruct (Colab, GPU A100) i per producció es va adoptar l'API de Groq (Llama), amb \*lib/llm/index.ts\* i \*lib/llm/groq.ts\*.
...
\- Llei 6/2024, sobre llenguatge accessible en l'administració pública. Butlletí Oficial del Principat d'Andorra.
...
\- Salamandra-7b-instruct (BSC). Barcelona Supercomputing Center. Disponible a: https://huggingface.co/BSC-LT/salamandra-7b-instruct
...
* Constitució del Principat d'Andorra (1993). Butlletí Oficial del Principat d'Andorra.  
* Llei 6/2024, del 25 d'abril, de la llengua pròpia i oficial.  
* Carretero González, C. (2018). *El derecho a entender el Derecho: una exigencia de la tutela judicial efectiva*.  
* Hart, H.L.A. (1961). *The Concept of Law*. Oxford University Press.  
* Katz, D. M., et al. (2023). *GPT-4 Passes the Bar Exam*. SSRN.  
* López Burniol, J.J. (2023). *La Constitució d'Andorra: Gènesi i Funció*.  
* Vilajosana, J.M. (2010). *El problema de l'existència del dret*. FUOC.  
* Projecte AINA. Barcelona Supercomputing Center (BSC-CNS).
...
[image1]: <data:image/png;base64,>