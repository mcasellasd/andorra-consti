/**
 * Script per generar embeddings del corpus del Llibre Sisè
 *
 * Ús:
 ...
 *   - Arxiu data/rag/llibre-sise.json amb les entrades de coneixement.
 */

const fs = require('fs');
const path = require('path');

const KNOWLEDGE_PATH = path.join(__dirname, '../data/rag/llibre-sise.json');
const OUTPUT_PATH = path.join(__dirname, '../data/rag/llibre-sise-embeddings.json');
