/**
 * Script per generar embeddings del corpus del Llibre Segon
 *
 * Ús:
 ...
 *   - Arxiu data/rag/llibre-segon.json amb les entrades de coneixement.
 */

const fs = require('fs');
const path = require('path');

const KNOWLEDGE_PATH = path.join(__dirname, '../data/rag/llibre-segon.json');
const OUTPUT_PATH = path.join(__dirname, '../data/rag/llibre-segon-embeddings.json');
