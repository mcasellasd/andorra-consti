# Implementació de prudencia.ad

## Resum de l'Implementació

Aquest document descriu les adaptacions realitzades al projecte existent per convertir-lo en **prudencia.ad**, el portal d'accessibilitat jurídica assistida per IA per al Principat d'Andorra segons el briefing tècnic proporcionat.

## ✅ Completat

### 1. Configuració del Projecte
- ✅ Actualitzat `package.json` amb nom i descripció de prudencia.ad
...
### 2. Chatbot Adaptat
- [ ] Adaptar `PrudenciaChatbot.tsx` per a consultes sobre dret andorrà
